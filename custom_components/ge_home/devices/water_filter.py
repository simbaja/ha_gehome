...
class WaterFilterApi(ApplianceApi):
    ...
    def get_all_entities(self) -> List[Entity]:
        ...
        wf_entities = [
            ...
            GeErdBinarySensor(self, ErdCode.WH_FILTER_LEAK_VALIDITY, device_class_override=BinarySensorDeviceClass.MOISTURE, entity_category=EntityCategory.DIAGNOSTIC),
            ...
            GeErdBinarySensor(self, ErdCode.WH_FILTER_FLOW_ALERT, device_class_override=BinarySensorDeviceClass.MOISTURE, entity_category=EntityCategory.DIAGNOSTIC),
        ]
