...
class UcimApi(ApplianceApi):
    ...
    APPLIANCE_TYPE = ErdApplianceType.UNDER_COUNTER_ICE_MAKER
    ...
    def get_all_entities(self) -> List[Entity]:
        ...
        ucim_entities = [
            ...
            GeErdBinarySensor(self, ErdCode.UCIM_BIN_FULL, device_class_override=BinarySensorDeviceClass.PROBLEM, entity_category=EntityCategory.DIAGNOSTIC),
        ]

        entities = base_entities + ucim_entities
        return entities
