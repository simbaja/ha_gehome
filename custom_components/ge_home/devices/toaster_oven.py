        ...
        entities.extend(
            [
                ...
                GeErdPropertySensor(
                    ...
                    "cook_mode",
                    erd_override="toaster_oven_cook_mode",
                    icon_override="mdi:toaster-oven",
                ...
                GeErdBinarySensor(
                    ...
                    erd_override="toaster_oven_convection",
                    icon_on_override="mdi:fan",
                    entity_category=EntityCategory.DIAGNOSTIC,
                ),
                GeErdSensor(
                    self,
                    ErdCode.TOASTER_OVEN_CURRENT_STATE,
                    erd_override="toaster_oven_current_state",
                    icon_override="mdi:toaster-oven",
                    entity_category=EntityCategory.DIAGNOSTIC,
                ),
                GeErdBinarySensor(
                    ...
                    erd_override="toaster_oven_remote_enabled",
                    icon_on_override="mdi:toaster-oven",
                    entity_category=EntityCategory.DIAGNOSTIC,
                ),
                GeErdSensor(
                    self,
